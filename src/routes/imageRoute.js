...
import { handleGetImageDetail, handleGetImages, handleSearchImagesByName, handleUploadImage, handleGetCommentByImage, handleCheckSavedImage, handleCommentOnImage, handleDeleteImage } from "../controllers/imageController.js";
...
imageRouter.delete('/delete-image', midVerifyToken, handleDeleteImage);
